      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <ul style={{ width: '100%', display: 'flex', justifyContent: 'space-evenly', fontSize: '20px' }} className='ReactLinkUl DFlex'>
            ...
            <li>
              <a href={`https://pinterest.com/pin/create/bookmarklet/?media=https://apiv1.spacenartists.com/uploads/1613980106987ProfileImage.png&url=https://spacenartists.com/artist-profile/${profile.id}&description=Please%20check%20my%20profile%20here..`} target='blank'>
