      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <ul style={{ width: '100%', display: 'flex', justifyContent: 'space-evenly', fontSize: '20px' }} className='ReactLinkUl DFlex'>
            {profile && profile.whatsapp !== null && profile.whatsapp !== 'null' && profile.whatsapp !== '' ? (
              <li>
                <a href={`https://api.whatsapp.com/send?text=Please%20check%20my%20profile%20here..%20https://spacenartists.com/artist-profile/${profile.id}`} target='_blank'>
                  <i className='fab fa-whatsapp icon'></i>
                </a>
              </li>
            ) : null}
            <li>
              <a href={`https://www.facebook.com/sharer.php?u=https://spacenartists.com/artist-profile/${profile.id}`} target='_blank'>
                <i className='fab fa-facebook-f icon'></i>
              </a>
            </li>
            <li>
              <a href={`https://pinterest.com/pin/create/bookmarklet/?media=${profile.profilePicture}&url=https://spacenartists.com/artist-profile/${profile.id}&description=Please%20check%20my%20profile%20here..`} target='blank'>
                <i className='fab fa-pinterest icon'></i>
              </a>
            </li>

            <li>
              <a href={`https://www.linkedin.com/shareArticle?url=https://spacenartists.com/artist-profile/${profile.id}&title=Please%20check%20my%20profile%20here..`} target='blank'>
                <i className='fab fa-linkedin-in icon'></i>
              </a>
            </li>
