        ...
        <Modal.Body>
          <ul style={{ width: '100%', display: 'flex', justifyContent: 'space-evenly', fontSize: '20px' }} className='ReactLinkUl DFlex'>
            ...
            <li>
             ...
             <li>
              <a href={`https://pinterest.com/pin/create/bookmarklet/?media=https://apiv1.spacenartists.com/uploads/1613980106987ProfileImage.png&url=https://spacenartists.com/artist-profile/$&description=I%20am%20a%20student..`} target='blank'>
